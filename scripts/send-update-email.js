...
<td style="padding:12px;">
  ...
  <td style="padding:12px;">
    ...
    <p>
      Black Friday is right around the corner, and now is the perfect time to create a wish list for the Holiday season!
    </p>

    <p>
      <a style="display:inline-block;padding:10px 15px;background-color:#329b22;color:#fff;text-decoration:none;border-radius:5px;font-size:18px;" href="https://giftdibs.com/profile">Create wish list</a>
    </p>
