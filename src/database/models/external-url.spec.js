...
describe('ExternalUrl schema', () => {
  ...
  it('should be invalid if url is too long', () => {
    _externalUrlDefinition.url = '';
    let externalUrl = new ExternalUrl(_externalUrlDefinition);
    const err = externalUrl.validateSync();
