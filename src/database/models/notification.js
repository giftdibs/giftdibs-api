...
function notifyNewFriendship(recipientId, sessionUser) {
  ...
  return fetchRecipient(recipientId)
    .then((recipient) => {
...
notificationSchema.statics.notifyNewFriendship =
  notifyNewFriendship;

notificationSchema.statics.notifyGiftComment =
  notifyGiftComment;

notificationSchema.statics.notifyGiftCommentAlso =
  notifyGiftCommentAlso;

notificationSchema.statics.notifyGiftReceived =
  notifyGiftReceived;

notificationSchema.statics.notifyGiftDelivered =
  notifyGiftDelivered;
